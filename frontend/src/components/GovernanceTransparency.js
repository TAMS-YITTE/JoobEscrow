  ...
  return (
    <div className="glass-panel p-6 mt-8 border border-white/10">
      ...
      <p className="text-gray-400 mb-6">
        The parameters below are read directly from the blockchain. We use a Timelock system to guarantee that 
        fees and rules cannot be changed instantly without notice.
      </p>
